...
\code{realCl03EquivQuaternionProd} and
\code{realEvenCl04EquivQuaternionProd}. The next crisp milestone is to
turn the $\Spin(4)$ Clifford-algebra model into the missing group-level
surjectivity statement for pairs of unit quaternions. Only after that
does it make sense to pursue $\Spin(5)$ and $\Spin(6)$.
