...
| Square-determinant Levi factorization, explicit chosen-model lift, and exact finite-basis spin-image iff (`thm:square-det-levi`) | `splitCliffordAction_list_prod_basisTransvectionCliffordUnit_eq_exteriorMap_prod`; `exists_basisScalingLinearEquivCliffordUnit_eq_smul_exteriorMap_of_prod_eq_sq`; `exists_linearEquivCliffordUnit_eq_smul_exteriorMap_of_det_eq_sq`; `exists_linearEquivCliffordUnit_eq_smul_exteriorMap_of_square_surjective`; `dualProdSpecialOrthogonalOf_basisTransvectionLinearEquiv_mem_spin_range`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_of_det_eq_one`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_of_det_eq_sq`; `exists_det_eq_sq_of_spinSpecialOrthogonalRepresentation_eq`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_iff_exists_det_eq_sq`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_of_square_surjective`; `dualProdSpecialOrthogonalOf_basisTransvectionLinearEquiv_mem_spin_range_of_two_lt_card`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_of_det_eq_one_of_two_lt_card`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_of_det_eq_sq_of_two_lt_card`; `dualProdSpecialOrthogonalOfLinearEquiv_mem_spin_range_of_square_surjective_of_two_lt_card` |
